...
BONUS_DAMAGE = "Bonus Dégâts";
BONUS_DAMAGE_ABBR = "B. Dmg";
BONUS_HEALING = "Bonus Soins";
...
CAMP_NOW = "Logout now";
CAMP_TIMER = "%d %s avant la déconnexion";
CANCEL = "Annuler";
...
COMBAT_RATING_NAME1 = "Compétence d'arme";
COMBAT_RATING_NAME10 = "Critique";
COMBAT_RATING_NAME11 = "Critique";
...
CONFIRM_XP_LOSS = "If you find your corpse, you can resurrect for no penalty.  If I resurrect you all of your items will take up to 25%% durability damage (equipped and inventory).";
...
FEETSLOT = "Feet";
FEMALE = "Female";
FERAL_DRUID_ITEM_AP = "Increases attack power by %d in Cat, Bear, and Dire Bear forms only.";
FILTER = "Filter";
FILTERS = "Filters";
...
HELPFRAME_GMTALK_ISSUE1 = "The Mentor System is a new Ascension Feature that will allow new Heroes to quickly find veterans who are willing to teach them about the game. If you find a Hero with a Green Flag above their characters head you can be sure that character is willing to answer questiosn, provide help and generally aid you.";
HELPFRAME_GMTALK_ISSUE1_HEADER = "Ascension Mentor System";
HELPFRAME_GMTALK_ISSUE2 = "The Ascension Wiki page is a community page closely maintained by both players and the Ascension Staff (|cffffd200www.ascension.gg/wiki|r). It contains info many aspect of the game, from Build Guides to explaining custom mechanics, and is an essential resource for Ascension: Classless WoW.";
HELPFRAME_GMTALK_ISSUE2_HEADER = "Browse the Ascension Wiki Website";
HELPFRAME_GMTALK_ISSUE3 = " ";
HELPFRAME_GMTALK_ISSUE3_HEADER = "Community Discord Server";
HELPFRAME_GMTALK_TEXT1 = "Ascension: Classless WoW has a dedicated team of full-time Game Masters that are available to assist 24 hours a day. The next available Game Master will be able to assist you. For non-urgent or general game related questions, please try the following steps before contacting a Game Master.";
HELPFRAME_GMTALK_TEXT2 = "Additionally, we encourage all players to first utilize the forums and the website to pursue information about their respective issues at |cffffd200www.ascension.gg|r , and request that specific attention be paid to our game policies at |cffffd200www.ascension.gg/terms-of-service/|r .";
...
INT_SPELL_DURATION_HOURS = "%d |4heure:hrs;";
...
ITEM_MOD_FERAL_ATTACK_POWER = "Increases attack power by %d in Cat, Bear, and Dire Bear forms only.";
...
ITEM_MOD_SPELL_HEALING_DONE_SHORT = "Bonus Soins";
...
ITEM_REQ_ARENA_RATING_3V3 = "Requires personal and team arena rating of %d|nin 2v2 or 3v3 brackets";
ITEM_REQ_ARENA_RATING_5V5 = "Requires personal and team arena rating of %d|nin 3v3 brackets";
...
LEVEL_REQUIRED = "Niveau Requis %d";
...
PLAYED = "Played";
PLAYER = "Player";
PLAYERSTAT_BASE_STATS = "Stats de base";
PLAYERSTAT_DEFENSES = "Défenses";
PLAYERSTAT_MELEE_COMBAT = "Mélées";
PLAYERSTAT_RANGED_COMBAT = "Distance";
PLAYERSTAT_SPELL_COMBAT = "Sorts";
...
PVP_POLICY_URL = "|cffffd200https://discord.gg/Ng3PA2z|r";
PVP_RANK_0_0 = "Scout";
...
QUIT = "Quit";
QUIT_NOW = "Maintenant !";
QUIT_TIMER = "%d %s avant la déconnexion";
RACE = "Race";
...
RAID_DIFFICULTY1 = "10-25 Player (Flexible)";
RAID_DIFFICULTY2 = "10-25 Player (Flexible Heroic)";
RAID_DIFFICULTY3 = "10 Player (Ascended)";
RAID_DIFFICULTY4 = "25 Player (Ascended)";
...
RESILIENCE_TOOLTIP = "Provides %.2f%% damage reduction against all damage done by players and their pets or minions.";
RESIST = "Resist";
...
RESISTANCE5_NAME = "Résistance a l'Ombre";
...
SPELL_STATALL = "Toutes les Stats";
...
TUTORIAL2 = "Use the W, A, S, D keys to move your character.";
...
TUTORIAL14 = "You can go to class trainers to learn new skills. |cffffd200Right Click|r on trainers to talk to them.|n|nTrainers are found in many towns or cities and always in your starting area. You may have to search around a little to find your trainer.";
TUTORIAL15 = "You can move spells and abilities to your action bar by clicking the |cffffd200Spellbook & Abilities Button|r at the bottom center of the screen (Hotkey - P) and then dragging the ability icon to your action bar.|n|nYou can access your Character Upgrades by pressing N and selecting Character Advancement.";
TUTORIAL16 = "You can look at your reputation with different groups in the world under the Reputation tab.|n|nClick on the |cffffd200Character Info Button|r (Hotkey C) to find the Reputation tab.";
...
TUTORIAL19 = "That’s another real person playing a character. You can tell by the blue name above their head. You can talk to them by pressing enter and typing a message. Press enter to send it.";
TUTORIAL20 = "|cffffd200Right Clicking|r an item in the vendor pane will buy that item if you have enough money.|n|nWhile the vendor pane is open, Right Clicking an item in your backpack will sell the item.|n|n If you accidently, sell an item, you can buy it back under 'Buyback'";
TUTORIAL21 = "You can view current quests by clicking on the |cffffd200Quest Log Button|r (Hotkey L) near the bottom middle of your screen.|n|nYou can view quest locations by clicking on the |cffffd200World Map Button|r at the top right of your screen.";
TUTORIAL22 = "If there is another player you have enjoyed playing with, add them to your friends list! Click on the |cffffd200Social Button|r (Hotkey O) and add them to your list of friends.|n|nYou can only add friends from your own realm.";
TUTORIAL23 = "You can send a message by hitting the Enter key, typing a message, and then hitting Enter again. Other players nearby will hear what you say. To talk in a world-wide channels by typing /1, /2, /3.";
TUTORIAL24 = "You can equip items by first clicking the |cffffd200Character Info Button|r (Hotkey C) near the bottom of the screen, and then the |cffffd200Backpack Button|r (Hotkey B) at the bottom right of your screen.|n|nThen just drag an equippable item from your backpack onto your character.";
...
TUTORIAL26 = "You are rested. Being rested gives you a temporary bonus to experience from killing monsters. You gain the rested bonus when near inns or while in cities.";
...
TUTORIAL42 = "To get started, you should begin a |cffffd200Quest|r.|n|nThere's a quest giver right in front of you. Tutorial tips will help you along the way.|n|nIf you still have questions, we have a wiki on our site, where you can learn more about Ascension!";
...
TUTORIAL46 = "You have joined a raid group: a group with an increased limit of 40 members, though usually between 10 and 25. Raid groups are necessary to enter the most challenging dungeons or to defeat the most powerful enemies, typically at high level.|n|n|cffff2020While in a raid group, you will not earn credit towards most quests. To leave a raid group, Right Click on your character portrait and select Leave party.|r";
...
TUTORIAL56 = "In the upper left corner of your screen is your health bar in green. When your health bar reaches zero, you will die, so be careful.|n|nBelow your health bar is a second bar representing the resources your hero uses to power your special abilities, red is rage, yellow is energy, blue is mana.";
...
TUTORIAL61 = "This is a trial version of World of Warcraft. Some features are not available. To experience all of the game go to www.ascension.gg.";
...
TUTORIAL_TITLE11 = "Food and Drink";
TUTORIAL_TITLE12 = "Food and Drink";
...
TUTORIAL_TITLE42 = "Welcome to Ascension WoW!";
...
VICTORY_TEXT_ARENA0 = "Purple Team Wins";
